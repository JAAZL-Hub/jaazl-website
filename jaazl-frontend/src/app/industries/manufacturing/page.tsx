      ...
      <section className="relative pt-36 pb-24 overflow-hidden text-white bg-gradient-to-br from-blue-900 via-slate-900 to-indigo-900">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            {language === 'en' ? 'Manufacturing Industry' : 'صناعة التصنيع'}
          </h1>
          <p className="text-xl md:text-2xl text-blue-200 mb-10 max-w-3xl mx-auto">
            {language === 'en' 
              ? 'Advanced solutions for manufacturing operations, automation, quality control, and industrial efficiency.' 
              : 'حلول متقدمة لعمليات التصنيع والأتمتة ومراقبة الجودة والكفاءة الصناعية.'}
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-600 text-center">
              {language === 'en' 
                ? 'This industry page is under development. Please contact us for more information about our manufacturing industry solutions.'
                : 'هذه الصفحة قيد التطوير. يرجى الاتصال بنا للحصول على مزيد من المعلومات حول حلول صناعة التصنيع.'}
            </p>
          </div>
        </div>
      </section>
