...
export const metadata: Metadata = {
  title: 'Industrial Waste Management Services | JAAZL',
  description: 'Comprehensive waste management solutions for industrial operations, focusing on reduction, treatment, and sustainable disposal practices.',
  keywords: ['waste management', 'industrial waste', 'waste treatment', 'circular economy', 'sustainability'],
};

export default function WasteManagementPage() {
  const service = engineeringServices.find(s => s.slug === 'waste-management');
